# -*- coding: utf-8 -*-
"""
Autodesk Inventor COM API 기반 자동 채점 스크립트 (grade_june15_pc10.py)
- PC-13 폴더를 기준(Reference)으로 삼아 PC-10 폴더의 제출물을 정밀 검사합니다.
- 주요 검사 항목:
  1. 파일명 규칙 위반 여부
  2. 부품 간 간섭 검사
  3. 조립 파일 링크 유실 여부
...
TARGET_DIR = r"D:\이갑종\26 3학년 전일제\6월15 TEST\PC-10_10.128.56.100"
...
def run_grading():
    ...
    # 2단계: 대상 폴더(PC-10) 채점 진행
    print("\n--- [2단계] 대상 폴더(PC-10) 채점 진행 중 ---")
    results = {}
    ...
    for folder in subdirs:
        ...
        if assembly and assembly.get("success"):
            ...
            md.append("| 부품 | 기준 체적 (PC-13) | 학생 체적 (PC-10) | 오차 비율 | 상태 |")
            md.append("| :--- | :---: | :---: | :---: | :---: |")
    ...
    print("\n" + "="*75)
    print(" 6월 15일 TEST PC-10 채점 완료 (기준: PC-13)")
    print("="*75)
